...
class CatalogCategoriesModel extends \Model
{
	 ...
	 * @var string
	 */
	protected static $strTable      = 'tl_catalog_categories_settings';
	protected static $strTableLocal = 'tl_catalog_categories_localization';
	 ...
	 * @return \Model|null The model or null if there is no event
	 */
	public static function findPublishedByPid($pid, $arrOptions=array())
	{
		$t = static::$strTable;
		$l = static::$strTableLocal;

		$arrColumns = array("($t.top_category=? AND published = 1)");
		$arrOptions = array();
